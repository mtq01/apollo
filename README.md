...
This project was inspired by a conversation with owner and CEO of an B2B Ecommerce Development Agency in Kelowna, who I'd asked what he looks for when hiring a junior developer. Rather than generic advice, he described a real, recurring front-end problem:
...
`.env.local` is gitignored, so it won't come down with a clone or pull. It needs:
